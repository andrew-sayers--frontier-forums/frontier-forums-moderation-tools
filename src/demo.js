...
(function(u) {
  ...
  */
  ...
  BabelExt.utils.dispatch(
    ...
    {
      // handlers must match at least one of the rules in every match_*, so for this rule:
      ...
      match_elements: [ '#foo' ], // handler is only called when a matching element is found - note this will not fire if the element isn't found, so will stop later matches from firing
      ...
      callback: function( pathname, params, foo, bar, baz, qux ) {
