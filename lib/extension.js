                    ...
                    get_requests.push(
                        $.get( '/showthread.php?t=' + thread_id, function(html) {
                            ...
                            if ( thread_id != real_thread_id ) {
                                alert(
                                    'Thread "' + title + '" was thread #'+thread_id + ', but has been merged into thread #'+real_thread_id + "\n" +
                                    "Please update the 'frequent merge destinations' variable, so quick-merge can manage this thread properly."
                                );
                            }
