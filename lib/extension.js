            ...
            callback: function( stash, pathname, params, below_body, dashboard_cache ) {
                ...
                bb.moderation_page( body_wrapper.find('iframe'), '/modcp/index.php?do=nav', '.navlink', '.navlink' ).then(function() {
                    ...
                    var dashboard = new Dashboard({
                        ...
                        header   : body_wrapper.find('.lastnavbit'),
                        interval : 60000,
                        bb       : bb,

                        monitor_post_queue: true,
                        monitor_newbies   : true,
                        monitor_threads   : [{ thread_id: 47517, name: 'the mod log' }],
                        monitor_forums    : [{
                            name: 'the reported posts forum',
                            forum_id: 48,
                            ...
                            useraction_data = {
                                ...
                                get_promises: function() {
                                    ...
                                    if ( issues.length == 1 ) {
                                        ...
                                        args.period  = 'M';
                                        args.expires = 3;
                                        ret.push(stash.give_custom_infraction( args ));
                                    }
