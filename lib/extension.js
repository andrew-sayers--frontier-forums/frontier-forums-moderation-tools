            ...
            function handle_thread() {
                ...
                function update_submit_message() {
                    ...
                    if ( notification_data.titles.length ) {
                        ...
                        actions.push( 'Give [i]' + user_to_review.text() + '[/i] an ' + notification_data.action_text );
                    ...
                    $('#submit-resolution').html( resolution_variables.overview.replace( /\[(\/?i)\]/g,'<$1>').replace( /\[notification_pic=(.*?)]/, '<img style="position:static" src="$1">' ) );
                    ...
                    stash.review_post_promise.done(function() {
                        ...
                        case 'pm':
                            ...
                            notification_data = {
                                ...
                                action_text: '[notification_pic=images/buttons/add-infraction_sm.png] explanatory PM',
                        ...
                        case 'infract':
                            ...
                            notification_data = {
                                ...
                                action_text: '[notification_pic='+image+'] ' + variables['infraction type'],
                                get_promises: function() {
                                    var issues = get_issues();
                                    var args = [
