            ...
            if ( pathname == '/showthread.php' && params.t == variable_thread_id && !params.page ) {
                ...
                $(function() {
                    stash.get_thread_posts( variable_thread_id, document.body )
                        .then(function(posts) { dfd.resolve(posts) });
                });
            } else if ( parseInt(variables_timestamp||'0',10)+reload_interval*1000 < new Date().getTime() ) {
                promise = stash.get_thread_posts( variable_thread_id );
            }
