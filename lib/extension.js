                            ...
                            function process_search_page(html, ul, depth) {
                                return $(html).find( '#cpform_table ul ul > li' ).map(function() {
                                    ...
                                    var li = $('<li style="margin-left:1em; list-style:disc"></li>')
                                        ...
                                        .append( '<span></span>' )
                                        .append(' - <a class="stopforumspam" href="//api.stopforumspam.org/api?username=' + encodeURIComponent(name) + '&amp;ip=' + encodeURIComponent(address) + '&amp;f=json">search on StopForumSpam.com</a>')
                                    ;
